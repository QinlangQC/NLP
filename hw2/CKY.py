...
def usage():
    sys.stderr.write("""
    Usage: python CKY.py [count_file] [test_file] [prediction_file]
        \n""")
...
def main():
    ...
    parameters.calculate('cfg_rare.counts')
    outfile = open('parse.prediction', 'w')
    for l in open('parse_dev.dat'):
